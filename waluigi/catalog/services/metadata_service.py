...
class MetadataService:
    ...
    def __init__(self, versions_repository: VersionRepository, metadata_repository: MetadataRepository):
        self.versions_repository = versions_repository
        self.metadata_repository = metadata_repository

    def get_version_metadata(self, dataset_id: str, version: str) -> dict:
        if not self.versions_repository.get(dataset_id, version):
            raise ValueError("Version not found")
        return self.metadata_repository.get(dataset_id, version)
    ...
    def set_version_metadata(self, dataset_id: str, version: str,
        ...
        self.metadata_repository.set(dataset_id, version, key, value)
    ...
    def delete_version_metadata(self, dataset_id: str, version: str,
        ...
        if not self.versions_repository.get(dataset_id, version):
            raise ValueError("Version not found")
        if not self.metadata_repository.delete(dataset_id, version, key):
