...
from waluigi.boss.api.schemas import TaskUpdateRequest, LogAppendRequest
from waluigi.boss.config.dependencies import task_service, update_service, log_service
