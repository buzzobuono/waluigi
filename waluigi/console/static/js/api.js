...
export const api = {
  ...
  catalogDeleteDataset:    (ns, id) => _delete(`/catalog/namespaces/${_enc(ns)}/datasets/${_enc(id)}`),
  catalogDatasetVersions:  (ns, id) => _get(`/catalog/namespaces/${_enc(ns)}/datasets/${_enc(id)}/versions`),
  catalogDeleteVersion:    (ns, id, ver) => _delete(`/catalog/namespaces/${_enc(ns)}/datasets/${_enc(id)}/versions/${_enc(ver)}`),
