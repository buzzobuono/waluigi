...
import JobHooks          from './components/JobHooks.js';
...
const routes = [
  ...
  { path: '/job-hooks',        component: JobHooks,        meta: { title: 'Job Hooks',        requiresAuth: true } },
  { path: '/secrets',          component: Secrets,         meta: { title: 'Secrets',          requiresAuth: true } },
