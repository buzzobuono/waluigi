...
from catalog_db_v2 import CatalogDB
...
class CommitRequest(BaseModel):
    ...
    schema:  Optional[Dict[str, Any]] = Field(None, alias="columns")
...
async def commit(collection: str, id: str, version: str,
    ...
    try:
        ...
        # Upsert schema columns (preserves human edits)
        db.upsert_schema_columns(collection, id, inferred)

        # Detect drift against published schema
